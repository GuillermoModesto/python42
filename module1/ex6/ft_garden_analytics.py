...
class GardenManager():
    ...
    def __init__(self, manager, plants=None, score=0):
    ...
    def create_garden_network(cls, managers):
        return [cls(manager) for manager in managers]

    class GardenStats():
        @staticmethod
        def get_manager_report(manager):
